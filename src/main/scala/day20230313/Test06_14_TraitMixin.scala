...
object Test06_14_TraitMixin {
  def main(args: Array[String]): Unit = {
    ...
    val studentWithTalent = new Student14 with Talent {
      override def dancing(): Unit = println("huahlkjhalgk ;alksdjfhg is good at dancing")

      override def singing(): Unit = println("huahlkjhalgk ;alksdjfhg is good at singing")
    }
...
class Student14 extends Person13 with Yong with Knowledge{
  // 重写冲突的属性
  override val name: String = "huzczczc"
